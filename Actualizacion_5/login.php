...
?>
<!DOCTYPE html><html><head><title>Login</title></head><head><style>body { font-family: Arial, sans-serif; background-color: #fafbfc; padding: 15px; } h1, h2 { color: #333; margin-bottom: 20px; }</style></head>
<body>
